...
let booting=false,ready=false,world=null,details=null,weather=null,presentWeather=null,weatherKey=null,flythrough=null,buildingFidelity=null,roadStyle=null,inspector=null,extensionsBound=false;
...
function expose(){
  window.BridgePointWorldV2300={version:VERSION,authoritative:true,cleanReplacement:true,architecture:'MAPLIBRE_SINGLE_CANVAS_TILE_LOD_PLUS_SEMANTIC_DETAIL_PLUS_BOUNDED_WEATHER_PLUS_LAZY_THREE_INSPECTOR',boot,world,details,weather,presentWeather,weatherKey,flythrough,buildingFidelity,roadStyle,inspector,get state(){return{version:VERSION,ready,booting,cleanReplacement:true,mainCanvases:document.querySelectorAll('#liveMap canvas').length,inspectorOpen:!document.getElementById('bp2300Inspector')?.hidden,world:world?.state||null,details:details?.state||null,weather:weather?.state||null,presentWeather:presentWeather?.state||null,weatherKey:weatherKey?.state||null,flythrough:flythrough?.state||null,buildingFidelity:buildingFidelity?.state||null,roadStyle:roadStyle?.state||null}}};
