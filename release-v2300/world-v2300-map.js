...
function style(){
 ...
 layers:[
  ...
  {id:'gta-landcover',type:'fill',source:'ofm','source-layer':'landcover',minzoom:2,paint:{'fill-color':['match',['downcase',['to-string',['coalesce',['get','class'],'']]],['wood','forest'],'#12221f',['grass','meadow'],'#16231f','farmland','#1c211f',['wetland','marsh'],'#11242a',['sand','beach'],'#24231d',['desert','dune'],'#211f1a',['bare_rock','rock','scree'],'#1f2222',['ice','glacier','snow'],'#263238',['scrub','heath'],'#17201d','#11191c'],'fill-opacity':['interpolate',['linear'],['zoom'],2,.34,8,.42,13,.5]}},
  {id:'gta-landcover-texture',type:'fill',source:'ofm','source-layer':'landcover',minzoom:9.2,layout:{visibility:'none'},paint:{'fill-pattern':['match',['downcase',['to-string',['coalesce',['get','class'],'']]],['wood','forest'],'bpterrain-forest',['grass','meadow'],'bpterrain-grass','farmland','bpterrain-farm',['wetland','marsh'],'bpterrain-wetland',['sand','beach'],'bpterrain-sand',['desert','dune'],'bpterrain-desert',['bare_rock','rock','scree'],'bpterrain-rock',['ice','glacier','snow'],'bpterrain-glacier',['scrub','heath'],'bpterrain-scrub','bpterrain-neutral'],'fill-opacity':0}},
  {id:'gta-landuse',type:'fill',source:'ofm','source-layer':'landuse',minzoom:7.5,paint:{'fill-color':['match',['downcase',['to-string',['coalesce',['get','class'],'']]],['park','recreation_ground'],'#15251f','grass','#17231f','cemetery','#182320','residential','#161b1e','commercial','#1b1d20','retail','#1d1e20','industrial','#202124','school','#202326','hospital','#222426','#171d1f'],'fill-opacity':['interpolate',['linear'],['zoom'],7.5,.26,14,.34,18,.42]}},
  {id:'gta-hillshade',type:'hillshade',source:'dem',minzoom:2,paint:{'hillshade-exaggeration':.62,'hillshade-shadow-color':'#0b1112','hillshade-highlight-color':'#d7d2b8','hillshade-accent-color':'#60706b'}},
  ...
  {id:'gta-road-major-shadow',type:'line',source:'ofm','source-layer':'transportation',minzoom:6.5,filter:roadFilter(['motorway','trunk','primary','secondary']),layout:{visibility:'none','line-cap':'round','line-join':'round'},paint:{'line-color':'#000000','line-width':1,'line-opacity':0}},
  {id:'gta-road-major-glow',type:'line',source:'ofm','source-layer':'transportation',minzoom:6.5,filter:roadFilter(['motorway','trunk','primary','secondary']),layout:{visibility:'none','line-cap':'round','line-join':'round'},paint:{'line-color':'#53717c','line-width':1,'line-opacity':0}},
  {id:'gta-road-major',type:'line',source:'ofm','source-layer':'transportation',minzoom:5.5,filter:roadFilter(['motorway','trunk','primary','secondary']),layout:{'line-cap':'round','line-join':'round'},paint:{'line-color':'#53717c','line-width':['interpolate',['linear'],['zoom'],5.5,.25,10,1.1,16,3.2,20,5.2],'line-opacity':['interpolate',['linear'],['zoom'],5.5,.34,12,.42,18,.52]}},
  ...
  {id:'gta-road-local-casing',type:'line',source:'ofm','source-layer':'transportation',minzoom:10.5,filter:roadFilter(['tertiary','minor','service','track']),layout:{visibility:'none','line-cap':'round','line-join':'round'},paint:{'line-color':'#53717c','line-width':1,'line-opacity':0}},
  {id:'gta-road-local',type:'line',source:'ofm','source-layer':'transportation',minzoom:10.5,filter:roadFilter(['tertiary','minor','service','track']),layout:{'line-cap':'round','line-join':'round'},paint:{'line-color':'#45616b','line-width':['interpolate',['linear'],['zoom'],10.5,.2,14,.65,17,1.45,20,2.6],'line-opacity':['interpolate',['linear'],['zoom'],10.5,.22,14,.3,18,.38]}},
  ...
  {id:'gta-city-floor-lines',type:'fill-extrusion',source:'bpCityStructures','source-layer':'buildings',minzoom:GLOBAL_FLOOR_MIN,layout:{visibility:'none'},paint:{'fill-extrusion-pattern':'bp-floor-lines','fill-extrusion-height':['max',3,['coalesce',['to-number',['get','render_height_m']],8.5]],'fill-extrusion-base':['max',0,['coalesce',['to-number',['get','base_height_m']],0]],'fill-extrusion-opacity':['interpolate',['linear'],['zoom'],GLOBAL_FLOOR_MIN,.72,17,.86,19,.96,21,1],'fill-extrusion-vertical-gradient':false}},
  ...
  {id:'gta-bp-floor-lines',type:'fill-extrusion',source:'bpBuildings','source-layer':'buildings',minzoom:GLOBAL_FLOOR_MIN,layout:{visibility:'none'},paint:{'fill-extrusion-pattern':'bp-floor-lines','fill-extrusion-height':['max',3,['coalesce',['to-number',['get','render_height_m']],8.5]],'fill-extrusion-base':['max',0,['coalesce',['to-number',['get','base_height_m']],0]],'fill-extrusion-opacity':['interpolate',['linear'],['zoom'],GLOBAL_FLOOR_MIN,.66,17,.82,19,.92,21,.96],'fill-extrusion-vertical-gradient':false}},
  ...
  {id:'gta-bp-tree3d-trunk',type:'fill-extrusion',source:'bpLivingWorld3D',minzoom:14.25,filter:['==',['get','part'],'tree_trunk'],paint:{'fill-extrusion-color':['coalesce',['get','trunk_color'],'#5b412d'],'fill-extrusion-base':['to-number',['get','base_m'],0],'fill-extrusion-height':['to-number',['get','top_m'],1],'fill-extrusion-opacity':.99,'fill-extrusion-vertical-gradient':true}},
  {id:'gta-bp-tree3d-canopy',type:'fill-extrusion',source:'bpLivingWorld3D',minzoom:14.25,filter:['==',['get','part'],'tree_canopy'],paint:{'fill-extrusion-color':['coalesce',['get','canopy_color'],['match',['get','leaf_cycle'],'evergreen','#285837','deciduous','#397344','#32673d']],'fill-extrusion-base':['to-number',['get','base_m'],0],'fill-extrusion-height':['to-number',['get','top_m'],1],'fill-extrusion-opacity':['interpolate',['linear'],['zoom'],14.25,.9,15,.95,17,.985],'fill-extrusion-vertical-gradient':true}},
  ...
  {id:'gta-bp-tree-trunks',type:'circle',source:'bpTreeLod',minzoom:13.6,maxzoom:22,filter:['==',['get','layer_key'],'TREE_OBJECTS_3D'],paint:{'circle-radius':['interpolate',['linear'],['zoom'],13.6,.45,14.25,.85,16,1.4,20,2.4],'circle-color':'#624832','circle-opacity':['interpolate',['linear'],['zoom'],13.6,.58,14.25,.9,16,.96]}},
  {id:'gta-bp-tree-crowns',type:'circle',source:'bpTreeLod',minzoom:12.6,maxzoom:22,filter:['==',['get','layer_key'],'TREE_OBJECTS_3D'],paint:{'circle-radius':['interpolate',['linear'],['zoom'],12.6,1.15,13.6,1.9,14.25,3.2,16,5.4,18,8.5],'circle-color':['interpolate',['linear'],['coalesce',['to-number',['get','height_m']],8],2,'#688c50',8,'#4c7842',20,'#35633a',35,'#294f31'],'circle-stroke-color':'rgba(30,68,40,.9)','circle-stroke-width':['interpolate',['linear'],['zoom'],12.6,.35,14.25,.8,16,1.05],'circle-opacity':['interpolate',['linear'],['zoom'],12.6,.58,13.6,.72,14.25,.9],'circle-blur':['interpolate',['linear'],['zoom'],12.6,.18,14.25,.06]}},
...
function floorLinePatternImage(){
 const size=64,cv=document.createElement('canvas');cv.width=size;cv.height=size;const x=cv.getContext('2d');x.clearRect(0,0,size,size);
 // Thin high-contrast cyan separators: readable as individual floor bands without masking the facade.
 x.strokeStyle='rgba(104,239,255,.96)';x.lineWidth=1.15;
 for(let y=15;y<size;y+=16){x.beginPath();x.moveTo(0,y+.5);x.lineTo(size,y+.5);x.stroke()}
 x.strokeStyle='rgba(4,24,31,.52)';x.lineWidth=.7;
 for(let y=16.5;y<size;y+=16){x.beginPath();x.moveTo(0,y);x.lineTo(size,y);x.stroke()}
 return x.getImageData(0,0,size,size)
}
...
export function initWorld(options={}){
 ...
 function treeCrownPoly(coord,r,n=15,seed='tree',squash=1){const h=treeHash(seed),rot=(h%6283)/1000,out=[];for(let i=0;i<n;i++){const a=rot+i/n*Math.PI*2,wave=Math.sin(i*2.31+(h%97)*.071)*.095,byte=(h>>>((i%4)*8))&255,jitter=((byte/255)-.5)*.22,rr=r*clamp(1+wave+jitter,.72,1.27),sx=1+Math.sin((h%31)+i*.83)*.055,sy=squash*(1+Math.cos((h%43)+i*.71)*.045);out.push([coord[0]+Math.cos(a)*rr*sx/metersLon(coord[1]),coord[1]+Math.sin(a)*rr*sy/110540])}out.push(out[0]);return[out]}
 ...
 function livingPhysical(data){
  ...
  for(const ft of data?.features||[]){if(used>=cap)break;const p=ft.properties||{},g=ft.geometry;if(!g)continue;
   ...
   if(g.type!=='Point'||!Array.isArray(g.coordinates))continue;const coord=g.coordinates,rawH=Number(p.height_m),renderH=Number(p.render_height_m),h=clamp(Number.isFinite(rawH)&&rawH>0?rawH:(Number.isFinite(renderH)&&renderH>0?renderH:8),2,80),sub=String(p.subtype||'').toLowerCase();
   ...
   if(p.layer_key==='TREE_OBJECTS_3D'||kind==='tree'){
    const crownD=Number(p.crown_diameter_m),trunkD=Number(p.trunk_diameter_m),trunkH=Number(p.trunk_height_m),crown=clamp(Number.isFinite(crownD)&&crownD>0?crownD*.5:h*.28,1.2,8),trunk=clamp(Number.isFinite(trunkD)&&trunkD>0?trunkD*.5:h*.035,.08,.7),base=clamp(Number.isFinite(trunkH)&&trunkH>0?trunkH:h*.32,1.2,Math.min(12,h*.72)),heightTruth=String(p.height_truth||((Number.isFinite(rawH)&&rawH>0)?'SOURCE_MEASURED_OR_DECLARED':'DERIVED_RENDER_HEIGHT')).toUpperCase(),positionTruth=String(p.position_truth||'SOURCE_POSITION'),leaf=String(p.leaf_cycle||p.properties?.tags?.leaf_cycle||p.subtype||'').toLowerCase(),species=String(p.species||p.properties?.tags?.species||''),seed=String(p.source_key||'tree')+'|'+String(p.source_record_id||p.tree_id||coord.join(',')),evergreen=/evergreen|conifer|needle|pine|spruce|fir|cedar|cypress/.test(leaf+' '+species),span=Math.max(.8,h-base);
    const trunkColor=evergreen?'#57412f':'#654832';
    out.push(
     {type:'Feature',geometry:{type:'Polygon',coordinates:treeCrownPoly(coord,trunk*1.08,8,seed+'|trunk0',1)},properties:{part:'tree_trunk',base_m:0,top_m:base*.62,trunk_color:trunkColor,height_truth:heightTruth,position_truth:positionTruth,truth:positionTruth}},
     {type:'Feature',geometry:{type:'Polygon',coordinates:treeCrownPoly(coord,trunk*.74,8,seed+'|trunk1',1)},properties:{part:'tree_trunk',base_m:base*.56,top_m:base,trunk_color:trunkColor,height_truth:heightTruth,position_truth:positionTruth,truth:positionTruth}}
    );
    const tiers=evergreen
      ?[[.9,0,.34,'#1f4b31'],[.72,.2,.58,'#285a38'],[.52,.44,.79,'#316842'],[.31,.67,1,'#3b754b']]
      :[[.72,0,.36,'#315f37'],[1,.15,.63,'#3b7040'],[.86,.43,.84,'#4a8048'],[.57,.68,1,'#5a8d52']];
    for(let ti=0;ti<tiers.length;ti++){const [rf,bf,tf,color]=tiers[ti];out.push({type:'Feature',geometry:{type:'Polygon',coordinates:treeCrownPoly(coord,crown*rf,evergreen?13:16,seed+'|crown'+ti,evergreen?.92:1)},properties:{part:'tree_canopy',base_m:base+span*bf,top_m:base+span*tf,canopy_color:color,crown_tier:ti,height_truth:heightTruth,position_truth:positionTruth,leaf_cycle:leaf,species,truth:heightTruth}})}
    used++
 ...
 async function livingWorld(){
  ...
  if(worldClientPressureBlocked()){scheduleLivingWorld(MOBILE?700:180);return}
  const z=map.getZoom(),seq=++livingSeq,b=bbox(map,MOBILE?.035:.06),tb=bbox(map,MOBILE?(z<14?.11:.045):(z<14?.16:.075)),baseLimit=MOBILE?(z>=16.5?520:360):(TIER==='HIGH'?(z>=16.5?1450:1000):(z>=16.5?1050:760)),treeLimit=MOBILE?(z>=17?420:z>=16?300:z>=14.25?170:z>=13.4?110:70):(TIER==='HIGH'?(z>=17?1150:z>=16?820:z>=14.25?420:z>=13.4?240:150):(z>=17?800:z>=16?560:z>=14.25?320:z>=13.4?190:120));lastLivingFetchAt=performance.now();
  try{
   const settled=await Promise.allSettled([
    z>=14.2?edge('bridgepoint-living-world-viewport-v5319',{west:b.west,south:b.south,east:b.east,north:b.north,limit:baseLimit},8500):Promise.resolve(EMPTY),
    edge('bridgepoint-global-tree-viewport-v1101',{west:tb.west,south:tb.south,east:tb.east,north:tb.north,limit:treeLimit},12000)
   ]);
   if(seq!==livingSeq||moving)return;
   const base=settled[0].status==='fulfilled'&&settled[0].value?.type==='FeatureCollection'?settled[0].value:EMPTY,trees=settled[1].status==='fulfilled'&&settled[1].value?.type==='FeatureCollection'?settled[1].value:EMPTY,features=[],seen=new Set();
   for(const f of [...(base.features||[]),...(trees.features||[])]){const p=f?.properties||{},g=f?.geometry,key=String(p.source_key||'')+'|'+String(p.source_record_id||'')+'|'+JSON.stringify(g?.coordinates||[]);if(seen.has(key))continue;seen.add(key);features.push(f)}
   const data={type:'FeatureCollection',features};if(features.length){
    ...
    window.__BP_TREE_RENDER_STATE__={version:1121,requested:(trees.features||[]).length,physicalFeatures:(physical.features||[]).length,visible3D:treeOn,visibleLod:treeLod,lodSource:'bpTreeLod',lodMinZoom:12.6,detailed3DMinZoom:14.25,geometry:'TAPERED_TRUNK_MULTI_TIER_IRREGULAR_CROWN',trunkLayer:(map.getLayoutProperty('gta-bp-tree3d-trunk','visibility')||'visible'),canopyLayer:(map.getLayoutProperty('gta-bp-tree3d-canopy','visibility')||'visible'),zoom:z,updatedAt:Date.now()}
   }
 ...
 function scheduleLivingWorld(delay=MOBILE?1200:120){clearTimeout(map.__bpLivingTimer);if(map.getZoom()<12.6)return;map.__bpLivingTimer=setTimeout(()=>{if(!moving)livingWorld()},delay)}
 ...
 function scheduleExact(delay=MOBILE?420:70){clearTimeout(detailTimer);if(PUBLIC_TECH_FAST){window.__BP_EXACT_DETAIL_STATE__={status:'interaction-only-tech-fast',visible:false,worldOverlay:false,updatedAt:Date.now()};return}detailTimer=setTimeout(()=>{if(!moving)exact()},delay)}
 ...
 function cityStructuresReady(){
  ...
  try{
   ...
   const ready=rendered>0||sourceFeatures>0;
   map.__bpCityReadyCheck={at:now,ready,rendered,sourceFeatures,sourceLoaded};
   window.__BP_CITY_BUILDING_HANDOFF_V5545__={version:5547,ready,sourceLoaded,rendered,sourceFeatures,zoom:map.getZoom(),center:map.getCenter(),rule:'loaded-current-viewport-features-promote-city-before-first-render',cachedMs:900,updatedAt:Date.now()};
   return ready
  }catch(_){return false}
 }
 ...
 function syncBuildingShells(){
  ...
  const cityFloorOn=cityReady&&floors;
  ...
  for(const id of [
   ...
   'gta-bp-building-shadow','gta-bp-facade-detail','gta-bp-building-edge','gta-bp-night-windows',
  ...
  window.__BP_BUILDING_SHELL_MODE__={
   ...
   publicTechFast:PUBLIC_TECH_FAST,
 ...
 function disableFineDetail(){
  ...
  for(const id of ['gta-road3d-curb','gta-road3d-deck','gta-road3d-bridge-rail','gta-road3d-bridge-pier','gta-streetlights-glow','gta-streetlights','gta-bp-tree3d-trunk','gta-bp-tree3d-canopy','gta-bp-streetlight3d-pole','gta-bp-streetlight3d-lamp','gta-bp-fountain3d-basin','gta-bp-fountain3d-water','gta-bp-landmark3d-plinth','gta-bp-landmark3d-body','gta-bp-sidewalk3d','gta-bp-shrub3d','gta-bp-sidewalk-casing','gta-bp-sidewalk','gta-bp-landmarks','gta-landmark-monuments'])vis(map,id,false);
  const z=map.getZoom(),keepTreeLod=z>=12.6&&!!map.getSource('bpTreeLod');vis(map,'gta-bp-tree-crowns',keepTreeLod);vis(map,'gta-bp-tree-trunks',keepTreeLod&&z>=13.6);
  window.__BP_FINE_DETAIL_MODE__={enabled:false,reason:'performance-first buildings-weather-boundaries',treeLodRetained:keepTreeLod,treeLodSource:'bpTreeLod',updatedAt:Date.now()}
 }
 ...
 const finalizeWorldCore=()=>{
  ...
  try{
   ...
   worldCoreReady=true;setTimeout(scheduleExact,MOBILE?350:220);if(map.getZoom()>=12.6)setTimeout(()=>scheduleLivingWorld(0),MOBILE?700:180);setStatus('BridgePoint World v5626 · owner-style fast tech map · white roofs · labels · realistic tree LOD');return true
 ...
 map.on('movestart',()=>movement(true));map.on('moveend',()=>movement(false));map.on('zoomend',()=>schedulePostMoveSettle());let bpCitySyncTimer=0,bpGlobalLodSyncTimer=0;map.on('sourcedata',e=>{
  ...
  if(e?.sourceId==='bpBuildings'){clearTimeout(bpCitySyncTimer);bpCitySyncTimer=setTimeout(()=>{if(!moving&&!map.isMoving?.())syncBuildingShells()},MOBILE?420:140);return}
