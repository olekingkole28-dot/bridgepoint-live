...
window.__BP_WORLD_RENDER_VERSION__=5367;
...
function style(){
 ...
 layers:[
  ...
  {id:'gta-context-buildings',type:'fill-extrusion',source:'ofm','source-layer':'building',minzoom:11.2,paint:{'fill-extrusion-color':'#7f878b','fill-extrusion-height':['max',4,bHeight],'fill-extrusion-base':0,'fill-extrusion-opacity':['interpolate',['linear'],['zoom'],11.2,.72,13,.86,15,.96,18,.995],'fill-extrusion-vertical-gradient':true}},
  ...
  {id:'gta-bp-roofs',type:'fill-extrusion',source:'bpBuildings','source-layer':'buildings',minzoom:MOBILE?15.8:13.8,layout:{visibility:'none'},paint:{'fill-extrusion-color':roofColor,'fill-extrusion-pattern':roofPattern,'fill-extrusion-base':['max',['coalesce',['to-number',['get','base_height_m']],0],['-',['max',3,['coalesce',['to-number',['get','render_height_m']],8.5]],['max',.18,['coalesce',['to-number',['get','roof_height_m']],.3]]]],'fill-extrusion-height':['max',3,['coalesce',['to-number',['get','render_height_m']],8.5]],'fill-extrusion-opacity':['interpolate',['linear'],['zoom'],13.8,.8,15,.94,18,.995],'fill-extrusion-vertical-gradient':true}},
...
function installBuildingMaterials(map){
 ...
 window.__BP_BUILDING_MATERIALS__={version:'v5367',mode:'structural-grey-3d',sourceBackedHeight:true,bridgePointGeometry:true,floorLines:true,facadeTextures:false,roofOverlays:true,exactRoofs:true,buildingParts:true,nightWindows:false,exactWorldOverlay:true,updatedAt:Date.now()}
}
...
function installWorldMaterials(map){
 ...
 window.__BP_WORLD_MATERIALS__={version:'v5367',biomes:true,glacierRelief:true,physicalRoads:true,blackYellowWhiteRoads:true,bridgeDecks:true,shorelineMotion:true,landmarks:true,updatedAt:Date.now()}
}
...
export function initWorld(options={}){
 ...
 function updateWorldLight(){
  ...
  try{
   ...
   window.__BP_WORLD_LIGHT__={version:5367,sunAltitude:alt,sunAzimuth:sun.az,daylight:day,night:night>0.55,twilight,moonlight:night>0.45,updatedAt:Date.now()}
 ...
 function syncBuildingShells(){
  ...
  vis(map,'gta-context-floor-lines',floorReady&&!useBp);
  vis(map,'gta-bp-floor-lines',floorReady&&useBp);
  ...
  vis(map,'gta-exact-floor-lines',exactReady&&floorReady);
  vis(map,'gta-exact-roof',exactReady&&roofReady);
  ...
  window.__BP_BUILDING_SHELL_MODE__={
   ...
   roofReady,
   roofMode:exactReady?'EXACT_PLUS_SOURCE_CAP':useBp?'BRIDGEPOINT_SOURCE_ROOF':'GLOBAL_SOURCE_ROOF',
   exactCount,
