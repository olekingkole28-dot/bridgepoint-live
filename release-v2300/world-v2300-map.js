...
function style(){
 ...
 layers:[
  ...
  {id:'gta-state',type:'line',source:'ofm','source-layer':'boundary',minzoom:2.2,filter:['==',['get','admin_level'],4],layout:{'line-cap':'round','line-join':'round'},paint:{'line-color':'#f2fdff','line-width':['interpolate',['linear'],['zoom'],2.2,1.05,3,1.15,7,1.55,9,1.9,15,2.5],'line-opacity':.97}},
