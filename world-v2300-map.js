...
function style(){
 ...
 layers:[
  ...
  {id:'gta-context-roofs',type:'fill-extrusion',source:'ofm','source-layer':'building',minzoom:GLOBAL_ROOF_MIN,layout:{visibility:'none'},paint:{'fill-extrusion-color':'#6f6c65','fill-extrusion-base':bBase,'fill-extrusion-height':['+',['max',4,bHeight],['max',1.15,bRoofHeight]],'fill-extrusion-opacity':['interpolate',['linear'],['zoom'],GLOBAL_ROOF_MIN,.9,14.8,.96,16,.99,18,1],'fill-extrusion-vertical-gradient':true}},
