...
| vsim MakeHuman CC0 humans | New default survivor + realistic infected human variants | CC0 MakeHuman/MPFB output; CMU walk mocap noted in source credits | https://github.com/kunalkushwaha/vsim/tree/main/packages/assets/library | Uses suited.glb for the survivor and human/man/speaker GLBs for infected variants. |
| vsim generated animals | Less-cartoon infected wolf/bear alternatives | MIT, generated by vsim's own Blender scripts | https://github.com/kunalkushwaha/vsim/tree/main/packages/assets/library | wolf.glb / bear.glb are used as additional hostile archetypes. |


## Native AAA visual target vs browser fallback

The browser/PWA can continue using legally cleared lightweight GLB assets for reach and testing, but those models are **not** the production visual target for the native Unreal Horizon client.

Native shipping priority:
- MetaHuman / City Sample quality for survivors, faces, bodies, hands, clothing and human-derived infected.
- Epic Game Animation Sample-quality locomotion and traversal.
- City Sample / Electric Dreams / qualified Fab free content for dense realistic world dressing.
- Poly Haven and ambientCG CC0 photoreal materials/models/HDRIs for engine-agnostic PBR detail.
