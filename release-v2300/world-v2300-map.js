...
function style(){
 ...
 layers:[
  ...
  {id:'gta-parcel-glow',type:'line',source:'bpParcels','source-layer':'parcels',minzoom:PARCEL_MIN,layout:{visibility:'none'},paint:{'line-color':'#00eaff','line-width':['interpolate',['linear'],['zoom'],PARCEL_MIN,2.8,11,3.6,15,5.2,18,7.2,21,9.5],'line-opacity':['interpolate',['linear'],['zoom'],PARCEL_MIN,.46,11,.38,16,.31,21,.24],'line-blur':['interpolate',['linear'],['zoom'],PARCEL_MIN,2.4,15,3.2,21,4.4]}},
  {id:'gta-parcel-halo',type:'line',source:'bpParcels','source-layer':'parcels',minzoom:PARCEL_MIN,layout:{visibility:'none'},paint:{'line-color':'#003cff','line-width':['interpolate',['linear'],['zoom'],PARCEL_MIN,1.35,11,1.8,15,2.5,20,3.6],'line-opacity':.78}},
  {id:'gta-parcel',type:'line',source:'bpParcels','source-layer':'parcels',minzoom:PARCEL_MIN,layout:{visibility:'none'},paint:{'line-color':['case',['>', ['coalesce',['get','render_score'],0],75],'#fff06a','#69f8ff'],'line-width':['interpolate',['linear'],['zoom'],PARCEL_MIN,.78,11,1.0,15,1.35,18,1.8,21,2.5],'line-opacity':1}},
