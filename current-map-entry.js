...
if(path==='/'||path.startsWith('/app/')||path.startsWith('/owner/')||path.startsWith('/admin/')||path.startsWith('/founder-access/')||path.startsWith('/for-')||path.startsWith('/sample/'))return;
