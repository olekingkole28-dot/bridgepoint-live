...
export function initStreetscapeDetail(map){
 ...
 function install(){
  ...
  const service=['all',['==',['get','class'],'service'],['!in',['downcase',['coalesce',['get','subclass'],'']],['literal',['pedestrian','footway','path','cycleway','steps']]]];
  ...
  const path=['any',['==',['get','class'],'path'],['in',['downcase',['coalesce',['get','subclass'],'']],['literal',['pedestrian','footway','path','cycleway','sidewalk']]]];
  ...
  const crossing=['in',['downcase',['coalesce',['get','subclass'],'']],['literal',['crossing','crosswalk']]];
  ...
  add(map,{id:'gta-road-edge-v2300',type:'line',source:'ofm','source-layer':'transportation',minzoom:9.3,filter:['in',['get','class'],['literal',['motorway','trunk','primary','secondary']]],layout:{'line-cap':'round','line-join':'round'},paint:{
