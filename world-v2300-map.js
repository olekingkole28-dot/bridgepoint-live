...
function style(){
 ...
 layers:[
  ...
  {id:'gta-context-roofs',type:'fill-extrusion',source:'ofm','source-layer':'building',minzoom:GLOBAL_ROOF_MIN,layout:{visibility:'none'},paint:{'fill-extrusion-color':'#6f6c65','fill-extrusion-base':['max',2.5,['-',['max',4,bHeight],.75]],'fill-extrusion-height':['+',['max',4,bHeight],['max',.8,bRoofHeight]],'fill-extrusion-opacity':['interpolate',['linear'],['zoom'],GLOBAL_ROOF_MIN,.78,14.8,.88,16,.96,18,.995],'fill-extrusion-vertical-gradient':false}},
