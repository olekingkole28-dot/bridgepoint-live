...
for token in [
    ...
    "ResolveSkillionHighEdge", "ResolveMansardInsetFootprint",
    "ResolveGambrelProfilePoints", "ResolveHalfHippedProfilePoints",
    "ResolveRoundRoofProfilePoints", "TriangulateRoofFootprint",
...
for token in [
    ...
    "EHorizonSourceRoofProfile::Mansard", "NormalizedShape == TEXT(\"mansard\")",
    "EHorizonSourceRoofProfile::Gambrel", "NormalizedShape == TEXT(\"gambrel\")",
    ...
    "MansardInset", "ResolveMansardInsetFootprint(Ring)",
    "one bounded four-vertex inset",
    "GambrelPoints", "ResolveGambrelProfilePoints(Ring)",
    "six bounded vertices in the existing mesh section",
    "HalfHippedPoints", "ResolveHalfHippedProfilePoints(Ring)",
    "four bounded vertices in the existing",
    "RoundRoofPoints", "ResolveRoundRoofProfilePoints(Ring)",
    "faceted barrel", "ProfileRoofHeightMeters * ShoulderScale",
    "DomeInset", "RoofProfile == EHorizonSourceRoofProfile::Dome",
    "five vertices in the existing mesh section",
    "DomeShoulderBase", "DomeApexIndex",
...
for token in [
    ...
    "Explicit rectangular mansard resolves to inset profile",
    "Source mansard height is preserved",
    "Non-rectangular mansard fails flat",
    "Valid mansard creates a four-corner inset",
    "Mansard inset remains inside the source footprint",
    "Concave mansard footprint fails closed",
    "Degenerate mansard footprint fails closed",
    "Explicit rectangular gambrel resolves to double-slope profile",
    "Source gambrel height is preserved",
    "Non-rectangular gambrel fails flat",
    "Valid gambrel creates four shoulders and two ridge points",
    "Gambrel shoulders follow the source footprint short axis",
    "Gambrel ridge follows the source footprint longest axis",
    "Concave gambrel footprint fails closed",
    "Degenerate gambrel footprint fails closed",
    "Explicit rectangular half-hip resolves to clipped profile",
    "Jerkinhead alias resolves to the half-hipped profile",
    "Source half-hip height is preserved",
    "Non-rectangular half-hip fails flat",
    "Valid half-hip creates two clipped shoulders and two ridge points",
    "Half-hip shoulders remain on source short-edge midpoints",
    "Half-hip ridge follows and remains inside the longest axis",
    "Concave half-hip footprint fails closed",
    "Degenerate half-hip footprint fails closed",
    "Explicit rectangular round roof resolves to barrel profile",
    "Barrel alias resolves to the round profile",
    "Source round roof height is preserved",
    "Non-rectangular round roof fails flat",
    "Valid round roof creates four shoulders and two ridge points",
    "Round roof shoulders form a symmetric barrel cross-section",
    "Round roof ridge follows the source footprint longest axis",
    "Concave round roof footprint fails closed",
    "Degenerate round roof footprint fails closed",
    "Explicit rectangular dome resolves to dome profile",
    "Domed alias resolves to the dome profile",
    "Source dome height is preserved",
    "Non-rectangular dome fails flat",
    "Valid dome reuses one bounded four-corner shoulder ring",
    "Dome shoulder ring remains inside the source footprint",
    "Concave dome shoulder geometry fails closed",
    "Degenerate dome shoulder geometry fails closed",
